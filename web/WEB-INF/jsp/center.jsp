    ...
    <script>
       ...
       function initCard(){
        ...
        function initOrder(){
            ...
            $.ajax({
                type:'post',
                url: "http://127.0.0.1:8080/Movie/order/findOrderByUserName",
                dataType:'json',
                data: {
                    ...
                    var layer = layui.layer;
                        layer.alert('是否确认要申请退票！',{icon: 0,offset: clientHeight/5},
                            function (){
                                $.ajax({
                                    type:'post',
                                    url: "http://127.0.0.1:8080/Movie/order/applyForRefund",
                                    dataType:'json',
                                    data: {
                                        order_id: order_id
                                    },
        ...
        function saveBtn(){
            ...
            if(user_email == ""){
                ...
                $.ajax({
                    type:'post',
                    url: "http://127.0.0.1:8080/Movie/user/uploadHeadImg",
                   // dataType:'json',
                    data: formData,
                    processData: false,
                    contentType: false,
        ...
        function savePasswordBtn(){
            ...
            if(user_old_password == "" || user_new_password == "" || user_repeat_password == ""){
                ...
                $.ajax({
                    type:'post',
                    url: "http://127.0.0.1:8080/Movie/user/modifyUserPwd",
                    dataType:'json',
                    data: {
