...
<div class="container">
    <div class="contents">
        ...
        <div class="nav-body">
            ...
            <!-- 影院管理 -->
            <div class="one card" style="display: none;">
                <div>
...
<script type="text/html" id="cinematoolbar">
    ...
    <div class="cinemacheck">
        <input id="cinemafindtext" type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入影院名称" class="layui-input">
        <button class="layui-btn layui-btn-sm" lay-event="findcinemabtn">搜索</button>
    </div>
</script>
...
<script>
    ...
    function initHtml(){
        ...
        AddCinemaHtml =
            ...
            "<div class=\"layui-input-block addcinematext\">" +
            "<input id=\"cinema_name\" type=\"text\" name=\"title\" lay-verify=\"title\" autocomplete=\"off\" class=\"layui-input\">" +
            "</div>" +
            "</div>" +
            "<div class=\"layui-form-item\">" +
            "<label class=\"layui-form-label\">地址</label>" +
            "<div class=\"layui-input-block addcinematext\">" +
            "<input id=\"cinema_address\" type=\"text\" name=\"title\" lay-verify=\"title\" autocomplete=\"off\"  class=\"layui-input\">" +
            "</div>" +
            "</div>" ;
    ...
    function initCinema(){
        ...
        layui.use(['laypage', 'layer', 'table'], function(){
            ...
            table.render({
                ...
                ,url: "/movie/cinema/findAll"
                ,method: 'post'
                ,toolbar: '#cinematoolbar'
                ,title: '用户列表'
                ,cols: [[
                    {field:'cinema_id', title:'影院ID', width:102, unresize: true, sort: true}
                    ,{field:'cinema_name', title:'影院名称', width:270, unresize: true,sort: true}
                    ,{field:'cinema_address', title:'影院地址', width:270, unresize: true, edit: "text"}
                    ,{title:'操作', width:300, unresize: true, align:'center', toolbar: '#cinemabar'}
                ]]
            ...
            table.on('tool(CinemaTable)', function(obj){
                var data = obj.data;
                if(obj.event === 'detail'){
                    layer.msg('ID：'+ data.cinema_id + '</br>账号：'+ data.cinema_name + '</br>地址：'+ data.cinema_address  , {offset: clientHeight/4,area: '300px;'});
                }
                    ...
                    layer.alert('确定要对id为“'+ JSON.stringify(data.cinema_id) + '”的影院修改进行保存吗？',{icon: 0,offset: clientHeight/5},
                        function () {
                            $.ajax({
                                type:'post',
                                url: "/movie/cinema/update",
                                dataType:'json',
                                data: {
                                    cinema_id: data.user_id,
            ...
            table.on('toolbar(CinemaTable)', function(obj){
                ...
                switch(obj.event){
                    case 'cinemaadd':
                        ...
                        layer.open({
                            ...
                            ,yes: function(){
                                var cinema_name = $('#cinema_name').val(),
                                    cinema_address = $('#cinema_address').val();
                        ...
                        break;
                    case 'findcinemabtn':
                        var cinema_name = $('#cinemafindtext').val();
                        table.reload('cinema_table_id', {
                            url: "/movie/cinema/findByName"
                            ,method: "POST"
                            ,where: {
                                cinema_name: cinema_name
                            }
    ...
    function initUser(){
        ...
        layui.use(['laypage', 'layer', 'table'], function(){
            ...
            table.render({
                elem: '#user_table_id'
                ,url: "http://127.0.0.1:8080/Movie" + '/user/findAllUser'
                ,method: 'post'
                ,toolbar: '#usertoolbar'
                ,title: '用户列表'
                ,cols: [[
                ...
                if(obj.event === 'detail'){
                    ...
                    layer.alert('确定要对id为“'+ JSON.stringify(data.user_id) + '”的用户修改进行保存吗？',{icon: 0,offset: clientHeight/5},
                        function () {
                            $.ajax({
                                type:'post',
                                url: "http://127.0.0.1:8080/Movie/user/updateUser",
                                dataType:'json',
                                data: {
                ...
                switch(obj.event){
                        ...
                        layer.open({
                            ...
                            ,yes: function(){
                                ...
                                if((user_name == "") || (user_pwd == "") || (user_email == "")){
                                    ...
                                    $.ajax({
                                        type:'post',
                                        url: "http://127.0.0.1:8080/Movie/user/register",
                                        dataType:'json',
                                        data: {
                                            user_name: user_name,
                                            user_pwd: user_pwd,
                    ...
                    case 'finduserbtn':
                        ...
                        table.reload('user_table_id', {
                            url: "http://127.0.0.1:8080/Movie" + '/user/findUserInfosByName'
                            ,method: "POST"
                            ,where: {
                                user_name: user_name
                            }
    ...
    function initMovies(){
        ...
        $.ajax({
            type:'post',
            url: "http://127.0.0.1:8080/Movie/movie/findAllMovies",
            dataType:'json',
            data: {},
            ...
            layer.open({
                ...
                ,yes: function(){
                    ...
                    if(flag == 0){
                        if(file == null){
                            ...
                            $.ajax({
                                type:'post',
                                url: "http://127.0.0.1:8080/Movie"+tempurl,
                                data: formData,
                                processData: false,
                                contentType: false,
                ...
                ,success: function(layero){
                    if(flag == 1){
                        ...
                        $.ajax({
                            type:'post',
                            url: "http://127.0.0.1:8080/Movie/movie/findMovieById",
                            dataType:'json',
                            data: {
                                movie_id: movie_id
                            },
        ...
        layui.use(['layer'], function(){
            ...
            layer.alert('确定要对id为“'+ movie_id + '”的电影修改进行下架吗？',{icon: 0,offset: clientHeight/5},
                function () {
                    $.ajax({
                        type:'post',
                        url: "http://127.0.0.1:8080/Movie/movie/deleteMovie",
                        dataType:'json',
                        data: {
                            movie_id: movie_id,
                        },
    ...
    function initComment(){
        ...
        layui.use('table', function(){
            ...
            table.render({
                ...
                ,url: "http://127.0.0.1:8080/Movie" + '/comment/findAllCommentsPage'
                ,method: 'post'
                ...
                if(obj.event === 'detail'){
                    ...
                    layer.alert('确定要对id为“'+ JSON.stringify(data.comment_id) + '”的评论内容修改进行保存吗？',{icon: 0,offset: clientHeight/5},
                        function () {
                            $.ajax({
                                type:'post',
                                url: "http://127.0.0.1:8080/Movie/comment/updateComment",
                                dataType:'json',
                                data: {
                    ...
                    layer.alert('确定要对id为“'+ JSON.stringify(data.comment_id) + '”的评论进行删除吗？',{icon: 0,offset: clientHeight/5},
                        function () {
                            $.ajax({
                                type:'post',
                                url: "http://127.0.0.1:8080/Movie/comment/deleteComemnt",
                                dataType:'json',
                                data: {
                                    comment_id: data.comment_id,
                                },
                ...
                switch(obj.event){
                    case 'findcommentbtn':
                        ...
                        table.reload('comment_table_id', {
                            url: "http://127.0.0.1:8080/Movie" + '/comment/findCommentsByUserName'
                            ,method: "POST"
                            ,where: {
                                user_name: user_name
                            }
    ...
    function initTicket(){
        ...
        layui.use('table', function(){
            ...
            table.render({
                ...
                ,url: "http://127.0.0.1:8080/Movie/order/findAllOrdersPage"
                ,method: 'post'
                ...
                if(obj.event === 'detail'){
                    ...
                    layer.alert('确定要通过订单编号为“' + data.order_id + '”的退票申请吗？',{icon: 0,offset: clientHeight/5},
                        function () {
                            $.ajax({
                                type:'post',
                                url: "http://127.0.0.1:8080/Movie/order/agreeForRefund",
                                dataType:'json',
                                data: {
            ...
            table.on('toolbar(TicketTable)', function(obj){
                ...
                switch(obj.event){
                        ...
                        if(PageStatus == 0){
                            if(changeticketbtn.val()=="订单编号"){
                                ...
                                table.reload('ticket_table_id', {
                                    url: "http://127.0.0.1:8080/Movie" + url_temp
                                    ,method: "POST"
                                    ,where: {
                                        order_id: find_temp
                                    }
                    ...
                    case 'backorderbtn':
                        ...
                        table.render({
                            elem: '#ticket_table_id'
                            ,url: "http://127.0.0.1:8080/Movie/order/findAllRefundOrder"
                            ,method: 'post'
                            ,toolbar: '#tickettoolbar'
                            ,title: '订单列表'
                            ,cols: [[
    ...
    function initSchedule(){
        ...
        layui.use(['table','form'], function(){
            ...
            table.render({
                elem: '#schedule_table_id'
                ,url: "http://127.0.0.1:8080/Movie" + '/schedule/findAllScheduleByState'
                ,method: 'post'
                ...
                if(obj.event === 'detail'){
                    ...
                    layer.alert('确定要对id为“'+ data.schedule_id + '”的场次进行下架吗？',{icon: 0,offset: clientHeight/5},
                        function () {
                            $.ajax({
                                type:'post',
                                url: "http://127.0.0.1:8080/Movie/schedule/offlineSchedule",
                                dataType:'json',
                                data: {
                                    schedule_id: data.schedule_id,
                                },
                        ...
                        layer.open({
                            ...
                            ,yes: function(){
                                ...
                                if((select_movie_name == "选择电影") || (select_cinema_name == "选择影院") || (select_schedule_hall == "选择放映厅") ||
                                    ...
                                    $.ajax({
                                        type:'post',
                                        url: "http://127.0.0.1:8080/Movie/schedule/addSchedule",
                                        dataType:'json',
                                        data: {
                            ...
                            ,success: function(layero){
                                ...
                                $.ajax({
                                    type:'post',
                                    url: "http://127.0.0.1:8080/Movie/schedule/findAllSchedule",
                                    dataType:'json',
                                    data: {},
                    ...
                    case 'findschedulebtn':
                        ...
                        if(ScheduleStatus==0){
                            table.reload('schedule_table_id', {
                                url: "http://127.0.0.1:8080/Movie/schedule/findScheduleByMovieName"
                                ,method: "POST"
                                ,where: {
                        ...
                        //下架
                            ...
                            table.reload('schedule_table_id', {
                                url: "http://127.0.0.1:8080/Movie/schedule/findOffScheduleByMovieName"
                                ,method: "POST"
                                ,where: {
                                    movie_name: find_temp
                                }
